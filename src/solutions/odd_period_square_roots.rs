...
fn sqrt_continued_fraction_period(value: i64) -> usize {
    ...
    // the numerator of an intermediate fraction.
    let (mut numerator_integer, mut denominator) = (froot as i64, 1);
    for period in 1.. {
        denominator = (value - numerator_integer.pow(2)) / denominator;
        let subtrahend = ((froot + numerator_integer as f64) / denominator as f64) as i64;
